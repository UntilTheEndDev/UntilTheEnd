 ...
 * @version V5.1.1
 */
public class Plank implements Listener{
	public static ItemStack item;
	public static NamespacedKey nsk=new NamespacedKey(Humidity.plugin,"ute.plank");
	public Plank() {		
		...
		inv.setItem(11,item);
		inv.setItem(15,new ItemStack(Material.LOG,4));
		UntilTheEndApi.GuideApi.addItemCraftInv("§6板条",inv);
