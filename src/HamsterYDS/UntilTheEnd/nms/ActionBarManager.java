...
public class ActionBarManager {
	...
	public static void sendActionBar(Player player,String line) {
		...
		try {
			...
			Object bar;
			if(NMSManager.version.equals("v1_12_R1")) bar=makePacketPlayOutChat.newInstance(obj,makeChatType.invoke(null,(byte)2));
			...
			System.out.println("[UTE]向玩家"+player+"的数据包"+line+"发送失败。");
		}  
	}
}
