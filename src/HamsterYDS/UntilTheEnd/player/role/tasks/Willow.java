						...
						for(int x=-5;x<=5;x++)
							for(int y=-5;y<=5;y++)
								for(int z=-5;z<=5;z++) {
									...
									case FIRE: System.out.println("awa");PlayerManager.change(player,CheckType.SANITY,1); break;
									case LAVA: PlayerManager.change(player,CheckType.SANITY,2); break;
									case STATIONARY_LAVA: PlayerManager.change(player,CheckType.SANITY,2); break;
									case WATER: PlayerManager.change(player,CheckType.SANITY,-1); break;
									case STATIONARY_WATER:  PlayerManager.change(player,CheckType.SANITY,-1); break;
									default: break;
									}
								}
